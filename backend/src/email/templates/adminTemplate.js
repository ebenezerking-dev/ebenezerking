...
export const adminTemplate = ({ name, email, message }) => {
	...
	<!-- CONTACT INFORMATION CARD -->
      ...
      <div style="text-align: center; margin-top: 30px;">
        <a href="mailto:${email}" class="mobile-btn" style="display: inline-block; padding: 12px 24px; background-color: #00485d; color: #ffffff; text-decoration: none; border-radius: 8px; font-weight: 600; margin: 0 5px;">
          Reply to ${name.split(" ")[0]}
        </a>
        <a href="https://ebenezerking.com"class="mobile-btn" style="display: inline-block; padding: 12px 24px; background-color: #ffffff; color: #00485d; text-decoration: none; border-radius: 8px; font-weight: 600; margin: 0 5px; border: 2px solid #00485d;">
          View Porfolio →
        </a>
      </div>
    </div>
